...
def grab_col_names(df, cat_th=10, car_th=20):
    ...
    Note: Numeric variables with categorical appearance are also included in categorical variables.

    Parameters
    ------
        df: DataFrame
                DataFrame for which variable names are to be obtained.
        cat_th: int, optional
    ...
    ------
        ...
        cat_but_car: list
                List of categorical variables with cardinal appearance.
...
def high_correlated_cols(dataframe, plot=False, corr_th=0.70):
    numerical_columns = dataframe.select_dtypes(include=[np.number])  # Sayısal sütunları seç
